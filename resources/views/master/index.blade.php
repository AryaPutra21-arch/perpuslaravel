            ...
            <div class="card-body">
              ...
              <div class="table-responsive pt-3">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <a href="{{ url('card/create') }}" class="btn btn-primary mt-5">Create</a>  
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <td>
                                    @yield ('edit')
                                    <a href="{{ route('card.edit',$item->id) }}" class="btn btn-primary">Edit</a>
                                    {{-- <a href="{{" --}}
                                    <a href="{{ route ('delete',$item->id)}}" type="submit" class="btn btn-danger">Hapus</a>
                                    {{-- <form action="{{ route('DVD.destroy', $item->id.)}}" method="post"> --}}
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
